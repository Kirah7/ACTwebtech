...
<body> 
   ...
   <main class="bg-sign-in d-flex justify-content-center align-items-center">
      <div class=" form-sign-in bg-white mt-2 h-auto mb-2 text-center pt-2 pe-4 ps-4 d-flex flex-column">
        <h1 class="ACT2F text-start ms-3 ps-1" >ACT2F</h1>
        <div>
    ...
    <label class="form-check-label" for="exampleCheck1">Remember Me</label>
        ...
        <button href="" class="btn-register btn btn-success mb-3">Register</button>
     </div>
   ...
   <div class="sign-up bg-white mt-2 h-auto mb-2 text-center pt-4 pb-3 pe-4 ps-4 d-flex flex-column">
       <div>
           <h2 class=" sign-in text-uppercase">Register</h2>
       </div>
       <form method="POST" id="signup" action="createaccout.php">
           ...
           <button type="submit" name="submit" class="btn text-white w-100 text-uppercase">Register</button>
           <p class="mt-4">you have account? <a href="index.php">Login</a></p>
       </form>
   </div>
   </div>
