...
<div class="student-list-header d-flex justify-content-between align-items-center py-2">
    <div class="title h6 fw-bold">ACT2F list</div>
...
if ($search) {
    $result = $con->query("SELECT * FROM students_list WHERE Name LIKE '%$search%' OR Email LIKE '%$search%' OR Phone LIKE '%$search%' OR EnrollNumber LIKE '%$search%' OR DateOfAdmission LIKE '%$search%'");
} else {
